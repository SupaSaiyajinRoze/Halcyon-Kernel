...
# Tweakable Stuff
export ARCH=arm64
export CROSS_COMPILE=/home/zamasu/letvkernel/aarch64-linux-android-4.9/bin/aarch64-linux-android-
export JOBS=16
export SUBARCH=arm
export KBUILD_BUILD_USER="Pavu"
export KBUILD_BUILD_HOST="Halcyon-Kernel"
